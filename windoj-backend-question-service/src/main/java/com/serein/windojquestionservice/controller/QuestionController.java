package com.serein.windojquestionservice.controller;
...
import com.serein.windojmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Page<QuestionSubmitVO>> listQuestionSubmitByPage(
        ...
        final User loginUser = userFeignClient.getLoginUser(request);   // 获取到登录用户
        // 返回脱敏信息
